CREATE TABLE `usuario` (
  ...
  `userfching` datetime DEFAULT NULL, //Fecha
  `userpswdest` char(3) DEFAULT NULL, //Estado
  `userpswdexp` datetime DEFAULT NULL,  //Fecha
  `userest` char(3) DEFAULT NULL,  //Estado
  `useractcod` varchar(128) DEFAULT NULL,   N/I
  `userpswdchg` varchar(128) DEFAULT NULL, N/I
